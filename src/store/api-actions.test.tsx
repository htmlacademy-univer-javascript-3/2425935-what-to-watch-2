...
describe('async actions', () => {
  ...
  it('authorization status is Auth if server has returned 200', async () => {
  ...
  it('should fetch similar films when GET /films/{id}/similar', async () => {
    mockAPI
  ...
  it('should fetch similar films when GET /comments/{id}', async () => {
    mockAPI
      .onGet('/comments/1')
  ...
  it('should post comment when POST /comments/{id}', async () => {
    const postData = {
      filmId: '1',
      comment: 'comment',
      rating: 8,
  ...
  it('should fetch favorite films when GET /favorite', async () => {
    mockAPI
      .onGet('/favorite')
      .reply(200, mockFilms);
  ...
  it('should post favorite film on POST /favorite/{filmId}/{status}', async () => {
    const postData = {
      filmId: '1',
      status: true
    };
